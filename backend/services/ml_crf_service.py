...
MODEL_PATH = BASE_DIR / "models" / "crf_resume_ner.joblib"
...
def fallback_name(text):
    ...
    for line in lines[:8]:
        ...
        # Fix spaced PDF names like: S H A I M A A L - W A H A I B I
...
def analyze_with_crf(text):
    tokens = tokenize(text)

    if not tokens:
        return {
            "model": "CRF Machine Learning",
            "tokens": [],
            "tags": [],
            "entities": {},
            "profile": {}
